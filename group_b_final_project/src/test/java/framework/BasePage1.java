 ...
 */
public class BasePage1 {private static WebElement webAction(final By locator) {
    ...
    public String getTextFromElement(By locator) {
        String text = null;
        try {
            text = webAction(locator).getAttribute("value");
        } catch (NoSuchElementException e) {
            Assert.fail("Element is not found with this locator: " + locator.toString());
            e.printStackTrace();
        }
    ...
    public String getTextFromElement1(By locator) {
        String text = null;
        try {
